...
if (isset($_POST["submit"])) {
    ...
    if ( $kelas  ) {
        ...
        echo '<script>alert("Gagal Menambahkan"); window.location.href = "kelas.php";</script>';
    }
                ...
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form action="" method="POST" class="requires-validation" novalidate>
                            ...
                            <div class="col-md-12">
                                <input class="form-control" type="text" name="id_kelas" placeholder="ID Kelas" 
                                    required>
                            </div>
                            ...
                            <div class="col-md-12">
                                <input class="form-control" type="text" name="kompetensi_keahlian" placeholder="Kompetensi_keahlian"
                                    required>
                            </div>
