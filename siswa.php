    ...
    <div class="container mt-3">
        <div class="d-flex mb-3">
            <form method="POST" class="d-flex mx-auto ">
                ...
                <button href="siswa.php" class="btn btn-secondary me-2" type="submit"
        ...
        <table class="table table-striped table-hover table-bordered">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>
                            <a href='edit_siswa.php?NIS={$row['NIS']}' style='color:white;'class='btn btn-warning'>Edit</a>
                            <a href='hapus_siswa.php?NIS={$row['NIS']}' class='btn btn-danger' onclick='return confirm(\"Are you sure?\")'>Hapus</a>
                        </td>";
                    echo "</tr>";
                }
                ?>
